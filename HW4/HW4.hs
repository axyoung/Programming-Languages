...
cmd (Pen m1) (m2, (x, y)) = ((m1, (x, y)), Nothing)
cmd (Move a b) (m2, (x, y)) = case m2 of
                            Down -> ((m2, (expr a, expr b)), Just ((x, y), (expr a, expr b)))
                            Up -> ((m2, (expr a, expr b)), Nothing)
...
--                    (s, Just l) -> (fst(block xs s), l:snd(block xs s))
